    ...
    return (
        <>
            ...
            <form className="max-w-sm mx-auto mt-10" onSubmit={formik.handleSubmit} >
                <h1 className="mb-5 text-lg font-bold">Reset Password:</h1>
                ...
                <div className="mb-5">
                    ...
                    <input type="password" id="newPassword" value={formik.values.newPassword} onChange={formik.handleChange} onBlur={formik.handleBlur} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                    {formik.touched.newPassword && formik.errors.newPassword ? <div className='bg-red-500 rounded-lg ps-5 py-5'>{formik.errors.newPassword}</div> : null}
                </div>
